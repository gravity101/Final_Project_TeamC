...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = 220
...
TRAJECTORY_BUILDER_2D.imu_gravity_time_constant = 20
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher.translation_weight = 30.
